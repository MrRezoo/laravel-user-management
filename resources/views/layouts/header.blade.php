            ...
            <ul class="nav-menus">
                ...
                @auth()
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20">
                            ...
                            <li><a href="#"><i data-feather="shield"></i>احراز هویت</a></li>
                            ...
                            <li>
                                <form action="{{route('logout')}}" method="post">
                                    @csrf
                                    <button class="text-primary" type="submit" href="{{route('logout')}}"><i data-feather="log-out"></i> خروج</button>
                                </form>
                            </li>
                        </ul>
                    </li>
                ...
                @guest()
                    <div class="col-lg-auto">
                        <a class="btn btn-info" href="{{route('login')}}">@lang('public.login')</a>
                        <a class="btn btn-info" href="{{route('register')}}"> @lang('public.register')</a>
                    </div>
                @endguest
            </ul>
